<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="占座时间" prop="zhanzuoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhanzuoshijian" 
                type="datetime"
                :readonly="ro.zhanzuoshijian"
                placeholder="占座时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhanzuoshijian" label="占座时间" prop="zhanzuoshijian">
              <el-input v-model="ruleForm.zhanzuoshijian" 
                placeholder="占座时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.zhanzuoshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weizhi = true;
          ...
          if(o=='zhanzuoshijian'){
            this.ruleForm.zhanzuoshijian = obj[o];
	    this.ro.zhanzuoshijian = true;
            continue;
          }
          if(o=='beizhu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yonghuzhanzuo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yonghuzhanzuoCrossAddOrUpdateFlag = false;
						 this.parent.search();
